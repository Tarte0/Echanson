...
public class ImageUtils {
    ...
    public static void saveBitmap(final Bitmap bitmap, final String filename) {
        final String root =
                Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "echanson";
    ...
    public static Bitmap convertB64ToBitmap(String pictureB64) {
        byte[] decodedBytes = Base64.decode(pictureB64.substring(pictureB64.indexOf(",") + 1), Base64.DEFAULT);
